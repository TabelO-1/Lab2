...
class NewDog {
    ...
    stateDogNameSpeciesPersonality() {
        dogs++
        let doggy = console.log(`My Dog's name is ${this.dogName}. ${this.dogGender} is a ${this.dogSpecies}. ${this.dogGender}'s personality is ${this.dogPersonality[0]} and likes ${this.dogPersonality[1]}. I have a total of number ${dogs} Dogs.`);
        return doggy;
    }
}
